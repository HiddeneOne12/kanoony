...
//
//     final subscribePackageModel = subscribePackageModelFromJson(jsonString);

import 'dart:convert';

SubscribePackageModel subscribePackageModelFromJson(String str) =>
    SubscribePackageModel.fromJson(json.decode(str));

String subscribePackageModelToJson(SubscribePackageModel data) =>
