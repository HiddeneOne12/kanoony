...
class PrivacyPolicyService {
  Future<Either<String, PrivacyPolicyModel?>?>
      getPrivacyPolicyContentRequest() async {
    try {
      String url = '';
      if (isArabic) {
        url = ApiConstants.getPrivacyPolicyContentUrl + ApiConstants.arabicKey;
      } else {
        url = ApiConstants.getPrivacyPolicyContentUrl;
      }
      ...
      if (response.statusCode == 200) {
        ...
        var data = PrivacyPolicyModel.fromJson(jsonResponse);
