...
//
//     final termsOfUseModel = termsOfUseModelFromJson(jsonString);

import 'dart:convert';

TermsOfUseModel termsOfUseModelFromJson(String str) =>
    TermsOfUseModel.fromJson(json.decode(str));

String termsOfUseModelToJson(TermsOfUseModel data) =>
