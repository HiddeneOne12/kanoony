...
class RegisterTradeMarkScreen extends ConsumerWidget {
  static const String trademarkRoute = "/RegisterTrademarkScreen";
  const RegisterTradeMarkScreen({super.key});
    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: const RegisterTradeMarkBody(),
        ),
      ),
    );
  }
