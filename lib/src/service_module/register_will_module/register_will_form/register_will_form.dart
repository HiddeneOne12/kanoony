...
class RegisterWillForm extends ConsumerWidget {
  static const String registerWillFormRoute = "/RegisterWillFormScreen";
  const RegisterWillForm({super.key});
    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: const RegisterWillFormBody(),
        ),
      ),
    );
  }
