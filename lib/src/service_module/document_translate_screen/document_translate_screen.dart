...
class DocTranslateScreen extends ConsumerWidget {
  static const String docTranslateRoute = "/DocTranslateScreen";
  const DocTranslateScreen({super.key});
