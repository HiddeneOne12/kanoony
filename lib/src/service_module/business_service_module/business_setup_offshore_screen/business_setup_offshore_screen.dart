...
class BusinessSetupOffshoreScreen extends ConsumerWidget {
  static const String businessSetupOffshoreRoute =
      "/BusinessSetupOffshoreScreen";
  const BusinessSetupOffshoreScreen({super.key});
    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: const BusinessSetupOffshoreBody(),
        ),
      ),
    );
  }
