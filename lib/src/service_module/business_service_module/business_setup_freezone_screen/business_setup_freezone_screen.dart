...
class BusinessSetupFreeZoneScreen extends ConsumerWidget {
  static const String businessSetupRoute = "/BusinessSetupFreeZoneScreen";
  const BusinessSetupFreeZoneScreen({super.key});
    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: const BusinessSetupFreeZoneBody(),
        ),
      ),
    );
  }
