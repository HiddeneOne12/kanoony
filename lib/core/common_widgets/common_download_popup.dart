...
import 'package:kanoony/core/common_widgets/common_promocode_popup.dart';
...
import 'download_by_package_popup.dart';

String selectedValue = '';
bool isError = false;
ValueNotifier<bool>? isLoading = ValueNotifier(false);
downloadDocumentPopUp(context, WidgetRef ref, DocDetail data) {
  var varaibles = ref.watch(allProviderList.dashboardProvider);
  var provider = ref.read(allProviderList.freeDocProvider.notifier);
  showDialog(
                            ...
                            CommonButton(
                                ...
                                onPressed: () async {
                                  if (selectedValue.isNotEmpty) {
                                    ...
                                    await provider.sendDownloadFreeDocRequest(
                                        ...
                                        onPressed: () async {
                                          if (userProfileHelper
                                            ...
                                            RoutesUtils.context.push(
                                                PackageScreen.packageRoute);
                                          } else {
                                            await downloadDocumentByPackagePopUp(
                                                context, ref, data);
                                          }
                                        }),
                                  ),
